...
assert.equal(shouldShowNonFoodVendorHeading([active]), true);
assert.equal(shouldShowNonFoodVendorHeading([]), false);
assert.equal(shouldShowNonFoodVendorHeading(null), false);
...
assert.match(explore, /shouldShowNonFoodVendorHeading\(bannerList\)/);
assert.match(explore, /Non-Food Vendors to Shop With/);
