...
const MarketplaceTicketCheckoutScreen = ({ navigation, route }) => {
  ...
  const purchase = async () => {
    ...
    try {
      ...
      const payload = { ga_quantity: ga, vip_quantity: vip, billing_address: billingAddress };
      const quoteResponse = await quoteMarketplaceTickets_API({ eventId: event.event_id, payload });
      ...
      const checkout = await checkoutMarketplaceTickets_API({
  ...
  return <View style={[styles.container, { paddingTop: insets.top }]}>
    <StatusBarManager /><AppHeader headerTitle="Buy Event Tickets" />
